                          ...
                          <ScrollStackItem key={item.title}>
                            ...
                            >
                              <Link
                                ...
                                prefetch={true}
                                onClick={() => setIsOpen(false)}
                                className={`group relative flex flex-col justify-between h-[70vh] min-h-[390px] sm:min-h-[520px] max-h-[720px] w-full rounded-3xl p-6 sm:p-12 md:p-16 transition-all duration-300 cursor-pointer ${
                                  isDark
                                    ? isPrimary
                              ...
                              >
                                ...
                                <div className="flex justify-between items-start mb-4 sm:mb-6 relative z-10">
                                  <div
                                    className={`w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-105 duration-200 ${
                                      isDark
                                        ? isPrimary
                                  ...
                                  <div className="flex items-center gap-3 sm:gap-6">
                                    ...
                                    <div
                                      className={`w-10 h-10 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full flex items-center justify-center transition-all duration-200 ${
                                        isDark
                                          ? isPrimary
                                    ...
                                    >
                                      <ArrowUpRight className="w-5 h-5 sm:w-7 sm:h-7 md:w-8 md:h-8 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-200" />
                                    </div>
                                  </div>
                                </div>

                                {/* Clean Main Heading & 1-Lined Info */}
                                <div className="my-auto py-2 sm:py-6 relative z-10">
                                  <h3
                                    className={`text-2xl sm:text-5xl md:text-7xl font-black tracking-tight leading-tight transition-colors duration-200 ${
                                      isDark
                                  ...
                                  <p
                                    className={`text-sm sm:text-xl md:text-3xl mt-2 sm:mt-5 max-w-3xl leading-relaxed font-medium ${
                                ...
                                <div
                                  className={`pt-4 sm:pt-6 border-t flex items-center justify-between font-mono text-[10px] sm:text-sm tracking-widest uppercase relative z-10 ${
                                    isDark
                                      ? 'border-white/10 text-slate-500'
                                      : 'border-slate-200/90 text-slate-400'
                                  }`}
                                >
                                  <span className="truncate max-w-[170px] sm:max-w-none">CodeBits Gateway</span>
                                  <span className="flex items-center gap-1.5 group-hover:text-[var(--brand-primary)] transition-colors font-bold shrink-0">
                                    Navigate <ArrowUpRight className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                                  </span>
                                </div>
                              </Link>
                            </motion.div>
